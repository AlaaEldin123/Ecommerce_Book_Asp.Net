/// This file is to reciev the data form API and reformat them in a shape
/// to be displaed to the client. as HTML. 
...
let ClsItems = {
 ...
 /// this template will render all of the HTML code spesified for showing the lists or showing 
/// the data that is coming for APIs.
    Template1: function (item) {
        ...
        itemHtml = itemHtml + "<div class='product__thumb'>";
        itemHtml = itemHtml + " <a class='first__img' href='/Items/Details/" + item.itemId + "'><img src='/Uploads/jpg.jpg' alt='product image'></a>";
        itemHtml = itemHtml + "<a class='second__img animation1' href='/Items/Details/" + item.itemId + "'><img src='/Uploads/jpg.jpg' alt='product image'></a>";
    ...
    ///for filtering the categories in the sidebar of the web page.
